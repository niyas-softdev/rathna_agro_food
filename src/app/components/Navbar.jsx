...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50">
      {/* ================= MAIN NAVBAR ================= */}
      <div className="bg-white/90 backdrop-blur-xl border-b border-orange-200 shadow-md">
  ...
  />
            ...
            {navLinks.map((link) => {
              ...
              return (
                <div key={link.href} className="relative group">
                  ...
                  <div className="absolute left-0 top-full mt-2 w-56 bg-white rounded-xl shadow-lg border border-orange-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                    <div className="py-2">
          ...
          <div className="hidden md:block">
            <Link
              href="/contact"
              className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-lg font-semibold shadow-md hover:shadow-lg transition"
            >
              Get a Quote
            </Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-orange-100 shadow-lg">
            <nav className="flex flex-col px-4 py-4 space-y-3 text-sm font-medium">
              ...
              <Link
                href="/contact"
                className="mt-3 text-center px-4 py-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-lg font-semibold"
              >
                Get a Quote
              </Link>
            </nav>
   ...
   {/* ─── PREMIUM TOP BAR (Bright with Orange Accent) ───────────────────── */}
