...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-[#0f172a] to-[#1e293b] text-white pt-12 pb-8 mt-12 border-t border-[#fbbf24]/20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="grid md:grid-cols-3 gap-8 md:gap-10">
          {/* Brand */}
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-[#fbbf24] to-[#f59e0b] flex items-center justify-center shadow-lg shadow-[#fbbf24]/30">
                <span className="text-sm font-bold text-[#0f172a]">RA</span>
              </div>
              <div className="flex flex-col leading-tight">
                <span className="font-bold text-base text-[#fbbf24]">
                  RATHNA
                </span>
                <span className="text-[10px] text-[#86efac] font-medium">
                  AGRO FOODS
                </span>
              </div>
            </div>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <h3 className="text-sm sm:text-base font-bold text-[#fbbf24] uppercase tracking-wider">
              Contact
            </h3>
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="rounded-lg border border-[#fbbf24]/30 px-3 py-1.5 text-[11px] sm:text-xs text-white/80 hover:bg-[#fbbf24]/10 hover:border-[#fbbf24] hover:text-[#fbbf24] transition-all duration-300"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="pt-3 space-y-2">
              <p className="text-xs text-white/70 font-medium">Connect</p>
              <div className="flex items-center gap-3">
                <a
                  href="https://www.facebook.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="h-9 w-9 rounded-lg border border-[#fbbf24]/30 flex items-center justify-center text-white/80 hover:bg-[#fbbf24]/10 hover:border-[#fbbf24] hover:text-[#fbbf24] transition-all duration-300"
                  aria-label="Facebook"
                >
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#fbbf24]/20 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] sm:text-xs text-white/60">
